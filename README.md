...
# How to cite #
D.G. Eliades, M. Kyriakou, S. Vrachimis and M.M. Polycarpou, "EPANET-MATLAB Toolkit: An Open-Source Software for Interfacing EPANET with MATLAB", in *Proc. Computing & Control for the Water Industry (CCWI)*, The Netherlands, Nov 2016, p.8. (doi:10.5281/zenodo.831493)
...
booktitle={Proc. Computing & Control for the Water Industry (CCWI)}, 
year={2016},
pages={8},

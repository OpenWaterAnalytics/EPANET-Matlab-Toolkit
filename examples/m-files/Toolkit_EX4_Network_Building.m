%% Build Network 
% This example shows how a network can be built just through toolkit function 
% calls, eliminating the need to always use an EPANET formatted input file. This 
% creates opportunities to use other sources of network data in one's code, such 
% as relational database files or GIS/CAD files.
% 
% Below is a schematic of the network to be built: <http://wateranalytics.org/EPANET/_example2.html 
...
%% Add the tank node at elevation of 850 ft, initial water level at 120 ft, minimum level at 100 ft, maximum level at 150 ft and a diameter of 50.5 ft

...
% * Create a matrix which will be used later in calculations. Define a 60 degree 
% counter-clockwise rotation matrix. 
% * Do the rotation: Shift points in the plane so that the center of rotation 
% is at the origin. Apply the rotation about the origin. Shift again so the origin 
% goes back to the desired center of rotation. 

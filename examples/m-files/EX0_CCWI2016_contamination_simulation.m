...
% Below, we provide a template solution on how to design an Arsenite contamination 
% simulator based on EPANET and EPANET-MSX using the EPANET-MATLAB Toolkit. More 
% about example: 
% 

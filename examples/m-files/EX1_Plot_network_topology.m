...
% * Plot for matlab apps (GUIs). Plot colors. Unload library.
%% Clear - Start Toolkit
...
h = d.plotGraph
title('Network Graph');
d.plotGraph('nodes', 'yes'); % Show ID of nodes
title('Network Graph with node IDs');
%% Unload library
